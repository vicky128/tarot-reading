...
// Worker API URL - replace with your Cloudflare Worker URL
const API_URL = 'https://tarot-interpreter.limeixu36.workers.dev';
...
async function getAIInterpretation() {
    ...
    try {
        ...
        // Display response
        aiResponse.innerHTML = responseData.result;
        console.log("AI 解读结果:", responseData.result);
